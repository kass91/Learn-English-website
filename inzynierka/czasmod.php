...
<div class="container">
	<div id="blog" class="col-lg-12">
        <div class="post3">
            ...
            <div class="post-tit3">Czasowniki Modalne - Modal Verbs </div>
            <div class="post-tre3">
            	<blockquote>Czasowniki modalne mają bardzo szerokie zastosowanie. Za ich pomocą możemy wyrazić:
<br/>umiejętność, zdolność (np. Potrafię mówić po angielsku.),
<br/>pozwolenie (np. Jeśli skończyłeś się uczyć, możesz iść do kina.),
<br/>prawdopodobieństwo, pewność (np. Długo się uczyłeś - na pewno jesteś zmęczony.),
<br/>konieczność, przymus (np. Każdy musi płacić podatki.),
<br/>prośbę (np. Czy mógłbyś otworzyć okno?),
<br/>propozycję, sugestię (np. Może poszlibyśmy do kina?).
<br/>
<br/>Większość czasowników modalnych ma tylko jedną, podstawową formę, która jest taka sama dla wszystkich osób. Nie dodajemy do nich żadnych końcówek ani operatorów. Pytania tworzymy przez inwersję, a w przeczeniach dodajemy NOT po czasowniku.
</blockquote><br /><br />
                 <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse1">Czasowniki modalne wyrażające umiejętność</a></h4>
                  </div>
                   <div id="collapse1" class="panel-collapse collapse">
                    <div class="panel-body">
					<?php
   						$myConnection= mysqli_connect("localhost","root","", "learnenglish") or die ("could not connect to mysql"); 
                                $sqlCommand="SELECT * FROM modal WHERE nazwa='umiejetnosc'";
               ...
               <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse2">Czasowniki modalne wyrażające prawdopodobieństwo</a></h4>
                  </div>
                   <div id="collapse2" class="panel-collapse collapse">
                    <div class="panel-body">
					<?php
   						$myConnection= mysqli_connect("localhost","root","", "learnenglish") or die ("could not connect to mysql"); 
                                $sqlCommand="SELECT * FROM modal WHERE nazwa='prawdopodobienstwo'";
                                $guery=mysqli_query($myConnection, "set names 'utf8'");
                                $query=mysqli_query($myConnection, $sqlCommand);            
                                  while($row = mysqli_fetch_array($query)){ ?>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse3">Czasowniki modalne wyrażające konieczność i przymus</a></h4>
                  </div>
                   <div id="collapse3" class="panel-collapse collapse">
                    <div class="panel-body">
					<?php
   						$myConnection= mysqli_connect("localhost","root","", "learnenglish") or die ("could not connect to mysql"); 
                                $sqlCommand="SELECT * FROM modal WHERE nazwa='koniecznosc'";
                                $guery=mysqli_query($myConnection, "set names 'utf8'");
                                $query=mysqli_query($myConnection, $sqlCommand);            
                                  while($row = mysqli_fetch_array($query)){ ?>
               ...
               <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse4">Czasowniki modalne wyrażające prośby, propozycje i pozwolenie</a></h4>
                  </div>
                   <div id="collapse4" class="panel-collapse collapse">
                    <div class="panel-body">
					<?php
   						$myConnection= mysqli_connect("localhost","root","", "learnenglish") or die ("could not connect to mysql"); 
                                $sqlCommand="SELECT * FROM modal WHERE nazwa='prosby'";
                                $guery=mysqli_query($myConnection, "set names 'utf8'");
                                $query=mysqli_query($myConnection, $sqlCommand);            
                                  while($row = mysqli_fetch_array($query)){ ?>
            ...
            <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse5">Ćwiczenia</a></h4>
                  </div>
                  <div id="collapse5" class="panel-collapse collapse">
                    <div class="panel-body">
                    <?php
					$myConnection= mysqli_connect("localhost","root","", "learnenglish") or die ("could not connect to mysql"); 
					$sqlCommand="SELECT * FROM wyniki WHERE `typ`='10' AND `IDUser`='{$_SESSION['id']}' ORDER BY `data` DESC LIMIT 5";
					$guery=mysqli_query($myConnection, "set names 'utf8'");
					$query=mysqli_query($myConnection, $sqlCommand);            
					$set = false;
					$wyniki = '';
                    ...
                    <form method="post" action="checkExercise.php?type=10">
					<?php
					$sqlCommand="SELECT * FROM exe WHERE `typ`='10'";
					$guery=mysqli_query($myConnection, "set names 'utf8'");
					$query=mysqli_query($myConnection, $sqlCommand);            
					$i = 1;
					while($row = mysqli_fetch_array($query)){ 
