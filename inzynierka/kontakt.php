...
<div class="container">
	<div id="blog" class="col-lg-12">
        <div class="post">
            ...
            <div class="post-tit">Kontakt</div>
            <div class="post-tre">W razie jakich kolwiek pytań, bądź problemów, prosimy o kontakt mailowy
            <br/><br/>Dział nauki e-mail: 
            <br/><i>nauka@learnenglish.com</i>
            <br/>
            <br/>Dział ćwiczeń e-mail: 
            <br/><i>exercise@learnenglish.com</i>
            <br/>
            <br/>Dział techniczny e-mail: 
            <br/><i>tech@learnenglish.com</i></div><br/>
