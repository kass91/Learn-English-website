...
<div class="container">
	<div id="blog" class="col-lg-12">
        <div class="post2">
            ...
            <div class="post-tit2">Czasy - Tenses</div>
            <div class="post-tre2">
            	<blockquote><b><i>Czas</i></b> - to przedewszystkim wielkość fizyczna, która określa kolejność zdarzeń oraz odstępy pomiędzy zdarzeniami zachodzącymi w tym samym momencie.</blockquote><br /><br />
                 <a href="present.php" title="czasy teraźniejsze" id="przy">
                    <div class="na">Czasy terażniesze</div>
                    <div class="li1"></div>
                    <div class="li2"></div>
                    <div class="li3"></div>	
                    <div class="li4"></div></a>
                 <a href="past.php" title="czasy przeszłe" id="przy">
                 	<div class="na">Czasy przeszłe</div>
                    <div class="li1"></div>
                    <div class="li2"></div>
                    <div class="li3"></div>	
                    <div class="li4"></div></a>
                 <a href="future.php" title="czasy przyszłe" id="przy">
                 	<div class="na">Czasy przyszłe</div>
                    <div class="li1"></div>
                    <div class="li2"></div>
                    <div class="li3"></div>	
                    <div class="li4"></div></a>
            </div><br/>
            <div class="post-podpis2"></div>  
        </div>
    </div>
    </div>
