...
<div class="container">
	<div id="blog" class="col-lg-12">
        <div class="post3">
            ...
            <div class="post-tit3">Rzeczowniki - Nouns </div>
            <div class="post-tre3">
            	<blockquote>W języku zngielskim wyróżniamy rzeczowniki policzalne (countable) i niepoliczalne (uncountable). Informację na ten właśnie temat, znajdziesz w tym dziale.</blockquote><br /><br />
                 <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse1">Rzeczowniki policzalne i niepoliczalne</a></h4>
                  </div>
            ...
            <div class="panel-group">
                <div class="panel panel-default">
                  ...
                  <div id="collapse4" class="panel-collapse collapse">
                    ...
                    <?php
					$myConnection= mysqli_connect("localhost","root","", "learnenglish") or die ("could not connect to mysql"); 
					$sqlCommand="SELECT * FROM wyniki WHERE `typ`='9' AND `IDUser`='{$_SESSION['id']}' ORDER BY `data` DESC LIMIT 5";
					$guery=mysqli_query($myConnection, "set names 'utf8'");
					$query=mysqli_query($myConnection, $sqlCommand);            
					$set = false;
					$wyniki = '';
                    ...
                    <form method="post" action="checkExercise.php?type=9">
					<?php
					$sqlCommand="SELECT * FROM exe WHERE `typ`='9'";
					$guery=mysqli_query($myConnection, "set names 'utf8'");
					$query=mysqli_query($myConnection, $sqlCommand);            
					$i = 1;
					while($row = mysqli_fetch_array($query)){ 
