...
<div class="container">
	<div id="blog" class="col-lg-12">
        <div class="post3">
            ...
            <div class="post-tit3">Kolory</div>
            <div class="post-tre3">
            	<blockquote>W tym dziale znajdziecie słownictwo związane z nazewnictwem kolorów w jezyku angielskim oraz ich odpowiedniki w języku polskim.</blockquote><br /><br />
                 <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse1">Kolory</a></h4>
                  </div>
            ...
            <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapse2">Ćwiczenia</a></h4>
                  </div>
                  <div id="collapse2" class="panel-collapse collapse">
                    <div class="panel-body">
                    <?php
					$myConnection= mysqli_connect("localhost","root","", "learnenglish") or die ("could not connect to mysql"); 
					$sqlCommand="SELECT * FROM wyniki WHERE `typ`='3' AND `IDUser`='{$_SESSION['id']}' ORDER BY `data` DESC LIMIT 5";
					$guery=mysqli_query($myConnection, "set names 'utf8'");
					$query=mysqli_query($myConnection, $sqlCommand);            
					$set = false;
					$wyniki = '';
                    ...
                    <form method="post" action="checkExercise.php?type=3">
					<?php
					$sqlCommand="SELECT * FROM exe WHERE `typ`='3'";
					$guery=mysqli_query($myConnection, "set names 'utf8'");
					$query=mysqli_query($myConnection, $sqlCommand);            
					$i = 1;
					while($row = mysqli_fetch_array($query)){ 
